<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-dark sidebar collapse nav-main">
    ...
    <div class="dropdown">
      ...
      <ul class="dropdown-menu dropdown-menu-dark text-small shadow" aria-labelledby="dropdownUser1">
        <li><a class="dropdown-item" href="<?=ROOT.ADMIN?>/profile"><i class="fa fa-user-circle"></i> Profile</a></li>
        <li><hr class="dropdown-divider"></li>
        <li><a class="dropdown-item" href="<?=ROOT.ADMIN?>/logout"><i class="fa fa-power-off"></i>  Sign out</a></li>
      </ul>
    </div>
